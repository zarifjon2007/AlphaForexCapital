...
import { BASE_OUR_PRICE_100K, DEFAULT_CHALLENGES, loadChallengesFromStorage, WHOP_CHECKOUT_URLS } from "@/lib/pricingConfig"
const COMPETITORS = [
  { name: "FTMO", price: "$540" },
  ...
  return (
    <section className="relative z-40 py-16 sm:py-20 px-3 sm:px-4 lg:px-6 overflow-hidden bg-[#020624]">
      <div className="relative max-w-4xl mx-auto">
        ...
        >
          <motion.a
            href={WHOP_CHECKOUT_URLS[selectedChallenge?.id ?? "100K"] ?? "/#pricing"}
            target="_blank"
